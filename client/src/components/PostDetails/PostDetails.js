    ...
    return (
        ...
        <Paper className='paper-post-detail'>
            <div className='content' >
                ...
                <div className={'post-detail-message'}><p style={{ marginTop: '-2rem', backgroundColor: 'rgb(253,253,253)', fontSize: '1.4rem', borderBottom: 'solid 0.1px rgb(240,240,240)', paddingBottom: '1.4rem', padding: '1.4rem', wordWrap: 'break-word', marginRight: 'auto', marginLeft: 'auto', maxWidth: '26rem'}}>{post[0].message}</p></div>
